<template>
	...
	>
		...
		<BaseTerminal
			...
			:empty-state-text="ctx.emptyStateText?.value"
			:empty-state-scale="ctx.emptyStateScale?.value"
			:empty-state-letter-gap="ctx.emptyStateLetterGap?.value"
			:empty-state-fill-char="ctx.emptyStateFillChar?.value"
			:empty-state-rain-chars="ctx.emptyStateRainChars?.value"
			:empty-state-rain-enabled="ctx.emptyStateRainEnabled?.value"
			:empty-state-fill-color="ctx.emptyStateFillColor?.value"
			:empty-state-rain-color="ctx.emptyStateRainColor?.value"
			:background-color="ctx.consoleBackgroundColor?.value"
